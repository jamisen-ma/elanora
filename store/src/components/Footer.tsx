        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-5">
              <a href="https://www.instagram.com/elanorajewelry_2024/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white/40 hover:text-gold-light transition-colors">
