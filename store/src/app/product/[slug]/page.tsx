...
export function generateStaticParams() {
  // Only generate pages for available (non-sold-out) products
...
export default async function ProductPage({
  ...
  const jsonLd = {
    ...
    image: product.images.map(
      (img) => `https://elanora-beta.vercel.app${img}`
    ),
          ...
          <div className="border-t border-cream-dark mt-6 pt-6">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-8 h-8 flex items-center justify-center rounded-full bg-cream text-warm-gray hover:bg-gold hover:text-white transition-colors"
